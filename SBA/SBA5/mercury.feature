Feature: This test the MercuryTours website
    ...
    Scenario: To check if First name is entered or not
    Given user navigates to "http://demo.guru99.com/test/newtours/register.php"
    When Enter name "Neethu" in "firstName"
    Then check  "/html/body/div[2]/table/tbody/tr/td[2]/table/tbody/tr[4]/td/table/tbody/tr/td[2]/table/tbody/tr[5]/td/form/table/tbody/tr[2]/td[2]/input"

    Scenario: mouse hover test
    Given user navigates to "http://demo.guru99.com/test/newtours/register.php"
