...
public class StepDefinition {
	...
	@When("Enter name {string} in {string}")
	public void name(String name,String first) {
		 driver.findElement(By.name(first)).sendKeys(name); 
	}

@When("check mouse hover to sign-on")
public void check_mouse_hover_to_sign_on() {
   WebElement element= driver.findElement(By.xpath("//a[contains(text(),'SIGN-ON')]\r\n"));
   ...
   action.moveToElement(element).click().perform();
	...
	public void check(String string) {
		 boolean check = driver.findElement(By.xpath(string)).isDisplayed();
		    Assert.assertEquals(check, true);
	}
	@Then("display current url")
	public void display_current_url() {
